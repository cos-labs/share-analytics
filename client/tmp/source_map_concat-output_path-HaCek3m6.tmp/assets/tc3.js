    ...
    exports['default'] = _ember['default'].Component.extend({
        ...
        fetchWidgetData: function fetchWidgetData() {
            ...
            data.then(function (json) {
                _this.set('aggregations', json.aggregations);
            });
            data.then(function (json) {
                _this.set('docs', json.hits.hits.map(function (hit) {
...
define('tc3/routes/application', ['exports', 'ember'], function (exports, _ember) {
...
define("tc3/templates/dashboard", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["block", "bs-accordion", [], ["selected", ["subexpr", "@mut", [["get", "selected", ["loc", [null, [16, 41], [16, 49]]], 0, 0, 0, 0]], [], [], 0, 0]], 0, null, ["loc", [null, [16, 16], [34, 33]]]], ["block", "sortable-objects", [], ["sortableObjectList", ["subexpr", "@mut", [["get", "sortableObjectList", ["loc", [null, [53, 51], [53, 69]]], 0, 0, 0, 0]], [], [], 0, 0], "sortEndAction", "sortEndAction"], 1, null, ["loc", [null, [53, 12], [72, 33]]]], ["attribute", "onclick", ["subexpr", "action", ["addChart"], [], ["loc", [null, [null, null], [77, 37]]], 0, 0], 0, 0, 0, 0], ["content", "outlet", ["loc", [null, [79, 0], [79, 10]]], 0, 0, 0, 0]],
      locals: [],
      templates: [child0, child1]
    };
  })());
...
if (!runningTests) {
  require("tc3/app")["default"].create({"LOG_RESOLVER":true,"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"tc3","version":"0.0.0+55ad9c19"});
}
