...
define('analytics-dashboard/tests/components/dropdown-widget/component.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/dropdown-widget/component.js should pass jshint.\ncomponents/dropdown-widget/component.js: line 32, col 40, Missing semicolon.\ncomponents/dropdown-widget/component.js: line 37, col 54, Missing semicolon.\ncomponents/dropdown-widget/component.js: line 51, col 30, Expected \'}\' to match \'{\' from line 3 and instead saw \'function\'.\ncomponents/dropdown-widget/component.js: line 51, col 38, Bad invocation.\ncomponents/dropdown-widget/component.js: line 51, col 50, Expected \')\' and instead saw \'{\'.\ncomponents/dropdown-widget/component.js: line 51, col 51, Missing semicolon.\ncomponents/dropdown-widget/component.js: line 53, col 32, Missing semicolon.\ncomponents/dropdown-widget/component.js: line 60, col 39, Unrecoverable syntax error. (27% scanned).\n\n8 errors');
  });
});
define('analytics-dashboard/tests/components/filter-plaques/component.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/filter-plaques/component.js should pass jshint.\ncomponents/filter-plaques/component.js: line 16, col 10, Missing semicolon.\ncomponents/filter-plaques/component.js: line 23, col 36, Missing semicolon.\ncomponents/filter-plaques/component.js: line 44, col 30, Expected \'}\' to match \'{\' from line 5 and instead saw \'function\'.\ncomponents/filter-plaques/component.js: line 44, col 38, Bad invocation.\ncomponents/filter-plaques/component.js: line 44, col 50, Expected \')\' and instead saw \'{\'.\ncomponents/filter-plaques/component.js: line 44, col 51, Missing semicolon.\ncomponents/filter-plaques/component.js: line 45, col 34, Missing semicolon.\ncomponents/filter-plaques/component.js: line 52, col 41, Unrecoverable syntax error. (71% scanned).\n\n8 errors');
  });
});
...
define('analytics-dashboard/tests/components/results-list/component.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/results-list/component.js should pass jshint.\ncomponents/results-list/component.js: line 15, col 16, Duplicate key \'pagebackbtn\'.\ncomponents/results-list/component.js: line 17, col 22, Expected \'===\' and instead saw \'==\'.\ncomponents/results-list/component.js: line 23, col 17, Duplicate key \'pagenextbtn\'.\ncomponents/results-list/component.js: line 31, col 57, Missing semicolon.\ncomponents/results-list/component.js: line 32, col 20, Missing semicolon.\ncomponents/results-list/component.js: line 39, col 98, Missing semicolon.\ncomponents/results-list/component.js: line 45, col 133, Missing semicolon.\ncomponents/results-list/component.js: line 48, col 135, Missing semicolon.\ncomponents/results-list/component.js: line 51, col 137, Missing semicolon.\ncomponents/results-list/component.js: line 54, col 133, Missing semicolon.\ncomponents/results-list/component.js: line 73, col 65, Missing semicolon.\ncomponents/results-list/component.js: line 83, col 65, Missing semicolon.\n\n12 errors');
  });
});
